...
seur_diem <- readRDS("data/processed/atsn/diem_debris/atsn.seur_obj.rds")
seur_ed <- readRDS("data/processed/atsn/emptydrops_debris/atsn.seur_obj.rds")
seur_q <- readRDS("data/processed/atsn/quantile_debris/atsn.seur_obj.rds")

m_diem <- FindAllMarkers
