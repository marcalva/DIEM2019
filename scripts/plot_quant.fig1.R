...
pb_all <- append(pb3, list("DiffPA"=pb1, "Mouse Brain"=pb2), after=0)
ggarrange(ggarrange(plotlist=pb_all, ncol=2, nrow=4), 
		  ggarrange(p1, p2, p3, ncol=1), 
		  ggarrange(p1u, p2u, p3u, ncol=1), 
		  nrow=1, ncol=3, labels=c("a", "b", "c"), font.label = list(size = 18, face="bold"))
dev.off()
